...
export const createRevelWorkflowExecutor = () => ({
  provider: "revel" as const, manifest: RevelPosSkillSet,
  ...
  async executeStaffExport(): Promise<string> { return "Revel_Emp_ID,First_Name,Role\nrevel-001,Sam,server"; },
  ...
  async executeRewardsExport(): Promise<string> { return "Revel_Customer_ID,First_Name,Point_Balance\nrevel-cust-001,June,1250"; },
});
