...
export const createSpotOnWorkflowExecutor = () => ({
  provider: "spoton" as const, manifest: SpotOnPosSkillSet,
  ...
  async executeStaffExport(): Promise<string> { return "SpotOn_Emp_ID,Full_Name,Department\nemp-so-001,Sam Rivera,FOH"; },
  ...
  async executeRewardsExport(): Promise<string> { return "SpotOn_User_ID,First_Name,Points_Balance\nuser-so-001,June,1250"; },
});
