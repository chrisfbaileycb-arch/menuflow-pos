...
export const createSquareWorkflowExecutor = () => ({
  provider: "square" as const, manifest: SquarePosSkillSet,
  ...
  async executeStaffExport(): Promise<string> { return "Square_Team_Member_ID,Name,Role\nteam-sq-001,Sam Rivera,server"; },
  ...
  async executeRewardsExport(): Promise<string> { return "Square_Customer_ID,Given_Name,Loyalty_Points\ncust-sq-001,June,1250"; },
});
