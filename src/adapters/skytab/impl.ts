...
export const createSkyTabWorkflowExecutor = () => ({
  provider: "skytab" as const, manifest: SkyTabPosSkillSet,
  ...
  async executeStaffExport(): Promise<string> { return "SkyTab_Emp_ID,Full_Name,Job_Code\nsky-001,Sam Rivera,server"; },
  ...
  async executeRewardsExport(): Promise<string> { return "Shift4_Member_ID,First_Name,Points_Accrued\nsky-mem-001,June,1250"; },
});
