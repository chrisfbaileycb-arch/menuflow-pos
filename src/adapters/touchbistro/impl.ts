...
export const createTouchBistroWorkflowExecutor = () => ({
  provider: "touchbistro" as const, manifest: TouchBistroPosSkillSet,
  ...
  async executeStaffExport(): Promise<string> { return "TB_Staff_ID,Staff_Name,Role_Type\ntb-001,Sam Rivera,server"; },
  ...
  async executeRewardsExport(): Promise<string> { return "TB_Account_ID,F_Name,Points_Balance\ntb-acc-001,June,1250"; },
});
